...
public class Calculator {
    ...
    private void handleData(List<Object> inputDataToHandle) {
    ...
    private String removeSquareBrackets(String s) {
    ...
    private List<Object> validateInputData(String inputData) throws InsufficientAmountOfDataException, IncorrectInputDataException, TooBigMatrixException, TooBigVectorExeption {
    ...
    private MatrixUtil isMatrix(String s) throws TooBigMatrixException {
    ...
    private MatrixUtil getMatrixFromString(String s) throws TooBigMatrixException {
    ...
    private VectorUtil getVectorFromString(String s) throws TooBigVectorExeption {
        s = removeSquareBrackets(s);
